  ...
  return <div className="min-h-[100dvh] bg-[var(--ivory)]">
    ...
    <main className="container-shell pb-24 pt-12 sm:pt-16">
      <section id="sumar" className="scroll-mt-32">
        <div className="grid items-end gap-8 lg:grid-cols-[1fr_auto]"><div><p className="eyebrow">Panoul Ritualul de Azi</p><h1 className="display mt-3 max-w-3xl text-5xl font-semibold leading-[.95] tracking-[-.045em] text-[var(--wine)] sm:text-7xl">Conținutul tău, într-un loc <em className="font-medium text-[var(--rose)]">liniștit.</em></h1><p className="mt-6 max-w-2xl text-sm leading-7 text-[var(--muted)] sm:text-base">Publică resurse, ajustează exercițiile și păstrează experiența coerentă. Schimbările apar în aplicație imediat după publicare.</p></div><div className="rounded-[18px] border border-[rgba(166,177,160,.42)] bg-[#eff2ed] px-5 py-4 text-sm text-[#52604e]"><span className="mr-2 inline-block size-2 rounded-full bg-[var(--sage)]" /> Sistem operațional</div></div>
