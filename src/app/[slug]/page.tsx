...
const pageDefinitions: Record<string, PageDefinition> = {
  ...
  confidentialitate: {
    ...
    description: "Politica de confidențialitate Starea Mea, explicată clar.",
    sections: [
  ...
  termeni: {
    ...
    copy: "Folosind Starea Mea, accepți regulile de bază care păstrează serviciul sigur, corect și previzibil.",
    description: "Termenii de utilizare pentru Starea Mea.",
    sections: [
      { label: "Serviciul", title: "Ce oferă Starea Mea", paragraphs: ["Starea Mea este un instrument digital de organizare, reflecție și wellbeing. Nu oferă diagnostic, tratament, psihoterapie sau intervenție de urgență.", "Poți folosi varianta gratuită sau un abonament Plus. Funcțiile incluse în fiecare plan sunt prezentate înainte de plată."] },
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const special: Record<string, [string, string]> = {
    ...
    contact: ["Contact", "Contactează echipa Starea Mea."],
  };
