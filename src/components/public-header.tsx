...
export function PublicHeader() {
  ...
  return <header className="sticky top-0 z-50 border-b hairline bg-[rgba(251,246,244,.92)] backdrop-blur-md">
    <div className="container-shell flex min-h-[82px] items-center justify-between gap-6">
      ...
      <div className="hidden items-center gap-2 lg:flex"><Link href="/resurse" aria-label="Caută în resurse" className="grid size-11 place-items-center rounded-full hover:bg-white"><Search size={18} /></Link><Link className="button-primary" href="/autentificare">Intră în cont</Link></div>
